...
const AgendamentoForm = {
    ...
    config: {
        ...
        // Cache de horários válido por 5 minutos
        cacheDuracaoMs: 300000
    },
    ...
    init() {
        ...
        // Iniciar contador de vagas e prova social
    ...
    async mostrarProvaSocial() {
        ...
        try {
            ...
            if (dados && dados.nome) {
                // Anonimizar nome (ex: "João S.")
                const nomeAnonimo = this.anonimizarNome(dados.nome);
                const tempoAtras = this.calcularTempoAtras(dados.timestamp);
                
                proofName.textContent = nomeAnonimo;
                proofAction.textContent = `agendou ${tempoAtras}`;
    ...
    async atualizarHorariosDisponiveis() {
        ...
        try {
            ...
            resultado.slots.forEach(slot => {
                ...
                option.style.color = '#4ade80'; // Verde para disponível
